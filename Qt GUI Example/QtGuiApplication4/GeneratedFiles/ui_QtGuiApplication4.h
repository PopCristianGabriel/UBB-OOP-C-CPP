...
public:
    ...
    void setupUi(QMainWindow *QtGuiApplication4Class)
    {
        if (QtGuiApplication4Class->objectName().isEmpty())
            QtGuiApplication4Class->setObjectName(QString::fromUtf8("QtGuiApplication4Class"));
    ...
    {
        QtGuiApplication4Class->setWindowTitle(QApplication::translate("QtGuiApplication4Class", "QtGuiApplication4", nullptr));
    } // retranslateUi
